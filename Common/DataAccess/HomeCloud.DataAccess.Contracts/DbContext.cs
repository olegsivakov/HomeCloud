namespace HomeCloud.DataAccess.Contracts
{
	...
	/// <summary>
	/// Provides functionality for access to database.
	/// </summary>
	/// <seealso cref="DbContext" />
	/// <seealso cref="IDbContext" />
	public class DbContext : ITransactionalDbContext, IDbContext
	{
		...
		public DbContext(string connectionString, bool isTransactional = false)
		{
